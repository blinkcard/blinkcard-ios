 ...
 */
- (void)recognizerRunner:(nonnull MBCRecognizerRunner *)recognizerRunner didFinishDetectionWithDisplayableQuad:(MBCDisplayableQuadDetection *)displayableQuad;
 ...
 */
- (void)recognizerRunner:(nonnull MBCRecognizerRunner *)recognizerRunner didFinishDetectionWithDisplayablePoints:(MBCDisplayablePointsDetection *)displayablePoints;

 ...
 */
- (void)recognizerRunnerViewControllerUnauthorizedCamera:(nonnull UIViewController<MBCRecognizerRunnerViewController> *)recognizerRunnerViewController;
 ...
 */
- (void)recognizerRunnerViewController:(nonnull UIViewController<MBCRecognizerRunnerViewController> *)recognizerRunnerViewController didFindError:(NSError *)error;
 ...
 */
- (void)recognizerRunnerViewControllerDidClose:(nonnull UIViewController<MBCRecognizerRunnerViewController> *)recognizerRunnerViewController;
 ...
 */
- (void)recognizerRunnerViewControllerWillPresentHelp:(nonnull UIViewController<MBCRecognizerRunnerViewController> *)recognizerRunnerViewController;
 ...
 *  @param recognizerRunnerViewController recognizerRunnerViewController Recognizer runner view controller responsible for scanning
 */
- (void)recognizerRunnerViewControllerDidResumeScanning:(nonnull UIViewController<MBCRecognizerRunnerViewController> *)recognizerRunnerViewController;
 ...
 *  @param recognizerRunnerViewController recognizerRunnerViewController Recognizer runner view controller responsible for scanning
 */
- (void)recognizerRunnerViewControllerDidStopScanning:(nonnull UIViewController<MBCRecognizerRunnerViewController> *)recognizerRunnerViewController;
 ...
 */
- (void)recognizerRunnerViewController:(nonnull UIViewController<MBCRecognizerRunnerViewController> *)recognizerRunnerViewController willSetTorch:(BOOL)isTorchOn;

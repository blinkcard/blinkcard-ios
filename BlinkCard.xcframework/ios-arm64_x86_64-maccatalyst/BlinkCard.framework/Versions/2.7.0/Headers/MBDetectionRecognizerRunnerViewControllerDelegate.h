...
@class MBCDisplayablePointsDetection;
@class MBCDisplayableQuadDetection;
 ...
 */
- (void)recognizerRunnerViewController:(nonnull UIViewController<MBCRecognizerRunnerViewController> *)recognizerRunnerViewController didFinishDetectionWithDisplayableQuad:(MBCDisplayableQuadDetection *)displayableQuad;
 ...
 */
- (void)recognizerRunnerViewController:(nonnull UIViewController<MBCRecognizerRunnerViewController> *)recognizerRunnerViewController didFinishDetectionWithDisplayablePoints:(MBCDisplayablePointsDetection *)displayablePoints;
 ...
 */
- (void)recognizerRunnerViewControllerDidFailDetection:(nonnull UIViewController<MBCRecognizerRunnerViewController> *)recognizerRunnerViewController;

 ...
 */
@property (nonatomic) NSArray<MBCOcrBlock *> *blocks;
 ...
 */
@property (nonatomic) MBCPosition *position;
 ...
 */
- (instancetype)initWithOcrBlocks:(NSArray<MBCOcrBlock *> *)ocrBlocks
 ...
 */
@property (nonatomic) NSArray<MBCOcrLine *> *lines;
 ...
 */
- (instancetype)initWithOcrLines:(NSArray<MBCOcrLine *> *)ocrLines position:(MBCPosition *)position NS_DESIGNATED_INITIALIZER;
 ...
 */
@property (nonatomic) NSArray<MBCCharWithVariants *> *chars;
 ...
 */
- (instancetype)initWithOcrChars:(NSArray<MBCCharWithVariants *> *)ocrChars position:(MBCPosition *)position NS_DESIGNATED_INITIALIZER;
...
MB_CLASS_AVAILABLE_IOS(13.0)
@interface MBCCharWithVariants : NSObject

/**
 * Character that was recognised
 */
@property (nonatomic) MBCOcrChar * character;
 ...
 */
- (instancetype)initWithValue:(MBCOcrChar *)character NS_DESIGNATED_INITIALIZER;
 ...
 */
- (instancetype)initWithValue:(unichar)value position:(MBCPosition *)position height:(CGFloat)height NS_DESIGNATED_INITIALIZER;

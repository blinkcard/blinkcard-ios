...
/**
 ...
 Those are events specified by MBCOverlayViewControllerDelegate protocol.
 */
 ...
 */
- (BOOL)overlayViewController:(MBCOverlayViewController *)overlayViewController willSetTorch:(BOOL)isTorchOn;

/**
 * If help mechanism is implemented using MBCScanDelegate's scanningViewControllerWillPresentHelp method,

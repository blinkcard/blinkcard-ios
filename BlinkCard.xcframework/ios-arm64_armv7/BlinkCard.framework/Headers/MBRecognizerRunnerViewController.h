...
@class MBCOverlayViewController;
@class MBCImage;

/** Block for returning high resolution MBCImage photo with capture or still output */
typedef void(^MBCCaptureHighResImage)(MBCImage * _Nullable highResImage);
...
/**
 * MBCRecognizerRunnerViewController's shouldAutorotate will return this value.
 *
 * Default: NO.
 *
...
/**
 * MBCRecognizerRunnerViewController's supportedInterfaceOrientations will return this value.
 *
 ...
 * Play scan sound.
 *
 * It uses default scan sound, you can change it by setting your own soundFilePath in MBCOverlaySettings.
 */

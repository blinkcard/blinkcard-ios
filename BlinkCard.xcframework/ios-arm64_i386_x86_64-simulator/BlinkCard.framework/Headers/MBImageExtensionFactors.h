 ...
 */
typedef struct MBCImageExtensionFactors {
    CGFloat top;
    CGFloat right;
    CGFloat bottom;
    CGFloat left;
} MBCImageExtensionFactors;

/**
 * Method which creates a image extension factors structure
 */
NS_INLINE MBCImageExtensionFactors MBCMakeImageExtensionFactors(CGFloat top, CGFloat right, CGFloat bottom, CGFloat left) {
    MBCImageExtensionFactors factors;
    factors.top = top;
    factors.right = right;

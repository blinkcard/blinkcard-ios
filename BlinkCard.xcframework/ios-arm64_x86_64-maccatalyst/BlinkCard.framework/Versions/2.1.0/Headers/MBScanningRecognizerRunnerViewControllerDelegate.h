 ...
 */
@protocol MBCScanningRecognizerRunnerViewControllerDelegate <NSObject>
@required
/**
...
- (void)recognizerRunnerViewControllerDidFinishScanning:(nonnull UIViewController<MBCRecognizerRunnerViewController> *)recognizerRunnerViewController state:(MBCRecognizerResultState)state;
